...
void OnTick()
  {
   double ima1 = iMA(Symbol(),time_1,MA_mid,0,MODE_LWMA,PRICE_CLOSE,1);
   double ima2 = iMA(Symbol(),time_1,MA_mid,0,MODE_LWMA,PRICE_CLOSE,2);
   double close_price1 = (iClose(Symbol(),time_1,1));
   double close_price2 = (iClose(Symbol(),time_1,2));
   //static double buy_send = OrderSend(Symbol(),OP_BUY,.1,Ask,0,0,0,NULL,0,0,clrNONE);
