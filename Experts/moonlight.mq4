//original legacy system but with smoothed price instead of price
/*
...
extern short MA_method = 0, smoothed_price_period = 2, MA_period = 21, ATR_gate_period = 14;
      ...
      for(i = 0; i < OrdersTotal(); i++)
        {
         if(OrderSelect(i,SELECT_BY_POS,MODE_TRADES))
           {
            if(OrderSymbol() == Symbol() && OrderMagicNumber() == moonlight)
              {
