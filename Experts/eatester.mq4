...
void OnTick()
  {
   ...
   double MA_1 = iMA(Symbol(),timeframe,20,0,MODE_SMA,PRICE_CLOSE,1);
   double MA_2 = iMA(Symbol(),timeframe,20,0,MODE_SMA,PRICE_CLOSE,2);
   ...
   if(price_1 > price_2 && MA_1 > MA_2 && price_1 > MA_1) bool buyer = true;
   if(price_1 < price_2 && MA_1 < MA_2 && price_1 < MA_1) bool seller = true;
   if(price_1 < MA_1) bool buy_closer = true;
   if(price_1 > MA_1)bool sell_closer = true;
