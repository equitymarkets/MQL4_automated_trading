         ...
         if(!time_randomizer)
           {
            if(price_1 > price_2)
              {
               buy = OrderSend(Symbol(),OP_BUY,lot,Ask,0,0,0," ",ea,0,clrNONE);
              }
            if(price_1 < price_2)
              {
               sell = OrderSend(Symbol(),OP_SELL,lot,Bid,0,0,0," ",ea,0,clrNONE);
              }       
           }
         else 
           {
         ...
         if(!time_randomizer)
           {
            if(price_1 > price_2)
              {
               buy = OrderSend(Symbol(),OP_BUY,lot,Ask,0,Ask - (stop_loss * pips),0," ",ea,0,clrNONE);
              }
            if(price_1 < price_2)
              {
               sell = OrderSend(Symbol(),OP_SELL,lot,Bid,0,Bid + (stop_loss * pips),0," ",ea,0,clrNONE);
              }       
           }
         else 
           {
