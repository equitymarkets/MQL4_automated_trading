      ...
      if(MA_low > MA_high)
        {
         ...
         else if(iRSI(Symbol(),timeframe,RSI_period,PRICE_CLOSE,1) < RSI_top)
           {
            confidence_level = 50;
           }
        }
      ...
      if(MA_low < MA_high)
        {
         ...
         else if(iRSI(Symbol(),0,RSI_period,PRICE_CLOSE,1) > RSI_bottom)
           {
            confidence_level = 50;
           }
        }
               ...
               if(OrderType() == OP_BUY) 
                 {
                  if(confidence_level < 25)
                    ...
                    {
                     if(iRSI(Symbol(),0,RSI_period,PRICE_CLOSE,1)>(RSI_middle + middle_adj))
                       {
