...
void OnTick()
  {
   ...
   double MA_1 = iMA(Symbol(),60,21,0,MODE_SMA,PRICE_CLOSE,1);
   double MA_2 = iMA(Symbol(),60,21,0,MODE_SMA,PRICE_CLOSE,2);
   double MA_3 = iMA(Symbol(),60,21,0,MODE_SMA,PRICE_CLOSE,3);
   ...
   if(price_1 > price_2 && price_1 > MA_1 && MA_1 > MA_2 && Minute() >= what_minute) bool buyer = true;
   if(price_1 < price_2 && price_1 < MA_1 && MA_1 < MA_2 && Minute() >= what_minute) bool seller = true;
   if(price_1 < MA_1 && Minute() >= what_minute) bool buy_closer = true;
   if(price_1 > MA_1 && Minute() >= what_minute) bool sell_closer = true;
