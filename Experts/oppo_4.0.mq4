//note: uses 1 hour for rand value
/*
...
input short timeframe = 240, stop_loss = 100, fast_period = 8, slow_period = 10, signal_period = 3;
input short what_minute = 0;
input bool time_randomizer = false, stops = true;
double pips;
