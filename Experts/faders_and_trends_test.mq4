...
extern bool time = false, random = false, stops = false, limits = false, limits_fade = true, weekend_breaker = false;
extern short what_minute = 0;
extern bool faders = false, trends = true;
int i;
double pips;
...
void OnTick()
  {
   ...
   if(price_0 > price_1 && price_1 > price_2 && price_2 > price_3 && Minute() >= what_minute) bool trends_buy = true;
   if(price_0 < price_1 && price_1 < price_2 && price_2 < price_3 && Minute() >= what_minute) bool faders_sell = true;
   if(price_0 < price_1 && price_1 < price_2 && price_2 > price_3 && Minute() >= what_minute) bool trends_sell = true;
   if(price_1 < price_2 && Minute() >= what_minute) bool faders_buy_closer = true;
   if(price_1 < price_2 && Minute() >= what_minute) bool trends_buy_closer = true;
   if(price_1 > price_2 && Minute() >= what_minute)bool faders_sell_closer = true;
   if(price_1 > price_2 && Minute() >= what_minute)bool trends_sell_closer = true;
