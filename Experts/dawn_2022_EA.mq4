...
int OnInit()
  {
   ...
   Comment("dawn_2022_EA.ex4 initialized!");
...
void OnDeinit(const int reason)
  {
   Alert("dawn_2022_EA.ex4 deinitialized!");
  }
...
void OnTick()
  {
   ...
   if(price_1 > price_2 && OBV_1 > OBV_2 && OBV_1 > 0 && Minute() >= what_minute) bool buyer = true;
   if(price_1 < price_2 && OBV_1 < OBV_2 && OBV_1 < 0 && Minute() >= what_minute) bool seller = true;
   if(price_1 < price_2 && ATR_fast_calc_1 < ATR_slow_calc_1 && ATR_fast_calc_1 < ATR_fast_calc_2 && ATR_slow_calc_1 < ATR_slow_calc_2 && Minute() >= what_minute) bool buy_closer = true;
   if(price_1 > price_2 && ATR_fast_calc_1 < ATR_slow_calc_1 && ATR_fast_calc_1 < ATR_fast_calc_2 && ATR_slow_calc_1 < ATR_slow_calc_2 && Minute() >= what_minute)bool sell_closer = true;
