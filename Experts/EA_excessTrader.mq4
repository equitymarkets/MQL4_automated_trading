...
void OnTick()
  {
   ...
   double early_lowest = iLow(Symbol(),timeframe,(iLowest(Symbol(),timeframe,MODE_LOW,10,5));
   double price_quick_1 = iClose(Symbol(),1,1);
   double price_quick_2 = iClose(Symbol(),1,2);
   double price_quick_hi_1 = iHigh(Symbol(),1,1);
   double price_quick_hi_2 = iHigh(Symbol(),1,2);
   int obv_quick_1 = iOBV(Symbol(),1,PRICE_CLOSE,1);
   int obv_quick_2 = iOBV(Symbol(),1,PRICE_CLOSE,2);
   
   if(current_low < early_lowest && price_quick_1 > price_quick_2 && price_hi_1 > price_hi_2 
      && obv_quick_1 > obv_quick_2) 
